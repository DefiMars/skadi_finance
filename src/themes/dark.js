...
const darkTheme = {
  ...
  background: `
    linear-gradient(180deg, rgba(245,136,49,0), rgba(0, 0, 10, 0.9)),
    linear-gradient(333deg, rgba(153, 207, 255, 0.2), rgba(245,136,49,0.15)),
    radial-gradient(circle at 77% 89%, rgba(243,98,52,255), rgba(125, 163, 169, 0) 50%),
    radial-gradient(circle at 15% 95%, rgba(239,61,50,255), rgba(125, 163, 169, 0) 43%),
    radial-gradient(circle at 65% 23%, rgba(245,136,49,0.2), rgba(137, 151, 119, 0) 70%),
